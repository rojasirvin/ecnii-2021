...
- Un **estimador M** $\hat{\theta}$ es un estimador que maximiza $Q_N$
...
- De forma general, un estimador M es un máximo local, calculado como la solución de las condiciones de primer orden :
