...
- Aunque la media condicional de $y^*$ es lineal, la media condicional de $y^*$, en precensia de truncamiento o censura, no lo es
...
.footnote[
[1] En CT, el IRM es $\frac{\phi(z)}{\Phi{z}}$. En otros textos, el IRM está definido como $1-\frac{\phi(z)}{\Phi{z}}$
]
