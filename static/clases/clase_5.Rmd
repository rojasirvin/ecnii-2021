...
- Partimos del hecho de que el estimador $\hat{\theta}$ es consistente y que $\sqrt{N}(\hat{\theta}-\theta_0)\to\mathcal{N}(\mathbf{0},C_0)$

- Por su parte $R(\theta^+)\xrightarrow{d} R(\theta_0)$ (la expansión de primer orden implica esto)
