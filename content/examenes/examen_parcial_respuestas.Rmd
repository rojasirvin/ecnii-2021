...
a. [] Escriba la log verosimilitud del problema para la muestra de tamaño $N$.
...
a <- quantile(data.ingresos$lwage, .9)
...
a. [5 puntos] ¿Cómo se interpreta el coeficiente asociado a **kww**?
    ...
    *Un incremento de una unidad en el puntaje del test medido en **kww** incrementa en 0.1052 el log de la razón de momios.*
